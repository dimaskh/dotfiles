...
awful.keyboard.append_global_keybindings{
   ...
   awful.key{
      ...
      keygroup    = 'numrow',
      description = 'view tag on each screen',
      group       = 'tag',
      on_press    = function(index)
...
awful.keyboard.append_global_keybindings{
  awful.key{
      ...
      description = 'firefox',
      groups      = 'applications',
      on_press    = function() awful.util.spawn("firefox-developer-edition") end,
  },
  awful.key{
      modifiers   = {mod.super},
      key         = 'c',
      description = 'chrome',
      groups      = 'applications',
      on_press    = function() awful.util.spawn("google-chrome-stable") end,
  },
}
