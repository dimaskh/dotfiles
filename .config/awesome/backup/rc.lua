...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = { "main", "www", "chat", "mail", "dev", "test", "docs", "env", "temp" }
    local l = awful.layout.suit
    local layouts = { l.max, l.max, l.max, l.max, l.max, l.max, l.max, l.max, l.max }
...
globalkeys = gears.table.join(
    ...
    -- Browsers
    awful.key({ modkey }, "f", function() awful.util.spawn("firefox-developer-edition") end,
