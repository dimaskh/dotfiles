...
local rofi_taskwarrior_cmd =
	"rofi -modi tasks:rofi-taskwarrior -show tasks -theme ~/.config/rofi/launchers/type-1/style-5.rasi"
...
awful.keyboard.append_global_keybindings({
	...
	end, { description = "chromium", group = "applications" }),
	...
	awful.key({ modkey, ctrlkey }, "c", function()
		awful.util.spawn(editor_gui)
	end, { description = "vscode", group = "applications" }),
	awful.key({ modkey }, "m", function()
		awful.util.spawn("deezer")
	end, { description = "deezer", group = "applications" }),
	awful.key({ modkey }, "v", function()
		awful.util.spawn("pavucontrol")
	end, { description = "pavucontrol", group = "applications" }),
	...
	awful.key({ modkey }, "]", function()
		awful.util.spawn("openssl rand -hex 12 | xclip -sel clip")
	end, { description = "generate random hash", group = "random" }),
	-- }}}
	...
	awful.key({ modkey }, "d", function()
		awful.util.spawn(
			string.format(rofi_cmd, beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus)
		)
	end, { description = "show rofi", group = "launcher" }),
	awful.key({ modkey, ctrlkey }, "t", function()
		awful.util.spawn(
			string.format(
				rofi_taskwarrior_cmd,
				beautiful.bg_normal,
				beautiful.fg_normal,
				beautiful.bg_focus,
				beautiful.fg_focus
	...
	end, { description = "show rofi-taskwarrior", group = "launcher" }),
	awful.key({ modkey }, "<", function()
		awful.util.spawn(
			string.format(
				rofi_buku_cmd,
	...
	end, { description = "show rofi-buku", group = "launcher" }),
	awful.key({ modkey, "Shift" }, "d", function()
		awful.spawn(
			string.format(dmenu_cmd, beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus)
		)
	...
	end, { description = "Wallpaper next", group = "wallpapers" }),
	awful.key({ altkey, shiftkey }, "Left", function()
		awful.util.spawn("variety -p")
	end, { description = "Wallpaper previous", group = "wallpapers" }),
	-- }}}
})
